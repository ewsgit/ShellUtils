                ...
                if (args[1]) {
                    switch (args[1].toLowerCase()) {
                        ...
                        case "list":
                            ...
                            break;
                        default:
                            // check if project args[1].toLoserCase() exists
                            if (settings.projects.findIndex(x => x.name === args[1].toLowerCase()) !== -1) {
                                callInfo("Opening project " + args[1]);
                                childProcess.exec(
                                    "s op " + settings.projects.find(x => x.name === args[1].toLowerCase()).path
                                );
                            }
                    }
                }
                        ...
                        switch (args[1].toLowerCase()) {
                            case "generate":
                                ...
                                if (fs.existsSync("~/AppData/Roaming/npm/node_modules".replace(/~/, os.homedir()))) {
                                    fs.readdir(
                                        "~/AppData/Roaming/npm/node_modules".replace(/~/, os.homedir()),
                                        (err, files) => {
